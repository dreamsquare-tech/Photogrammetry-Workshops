...
- [3D・バーチャルの世界を知ろう（中学・高校生向け）](#3dバーチャルの世界を知ろう中学高校生向け)
  - [本講義の目標](#本講義の目標)
  - [もくじ](#もくじ)
  - [1. バーチャル（バーチャル空間）とは](#1-バーチャルバーチャル空間とは)
  - [2. バーチャル空間（メタバース空間）の例](#2-バーチャル空間メタバース空間の例)
  - [3. 3Dモデルの作り方（2種類紹介）](#3-3dモデルの作り方2種類紹介)
  - [4. フォトグラメトリのやり方（2種類紹介）](#4-フォトグラメトリのやり方2種類紹介)
  - [5. フォトグラメトリの仕組み](#5-フォトグラメトリの仕組み)
  - [まとめ](#まとめ)
...
- ### 4.2 Scaniverse[^6] 使って3Dモデルを作る方法
